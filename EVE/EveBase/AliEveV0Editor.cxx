...
void AliEveV0Editor::DisplayDetailed()
{
    ...
    //     snprintf("entered V0 loop:" << colors[0] << "\t"<< colors[1] << "\t"<< colors[2] << std::endl;
    ...
    pvlocation->SetMarkerColor(colors[0]);
    ...
    v0location->SetMarkerColor(colors[0]);
    ...
    if (negDaughterCluster){
        ...
        negDaughterCluster->SetMarkerColor(colors[1]);
    }
    else
    {
    ...
    if (posDaughterCluster){
        ...
        posDaughterCluster->SetMarkerColor(colors[2]);
    }
    else
    {
