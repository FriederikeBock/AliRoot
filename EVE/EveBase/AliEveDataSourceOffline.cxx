...
void AliEveDataSourceOffline::GotoEvent(Int_t event)
{
    ...
    if(selectedTrigger == "No trigger selection")
    {
      ...
      cout<< "full trigger list: "<< fCurrentData.fESD->GetFiredTriggerClasses() << endl;;
      cout<< "primary vertex position: " << fCurrentData.fESD->GetPrimaryVertex()->GetZ() << endl;
      foundTrigger = true;
